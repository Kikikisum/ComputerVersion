...
from segment.fcn.distributed import ConfusionMatrix,MetricLogger,SmoothedValue
...
def evaluate(model, data_loader, device, num_classes):
    ...
    with torch.no_grad():
        for image, target in tqdm(data_loader):
            ...
            # Perform argmax on the output Tensor
            output = torch.argmax(output_tensor, dim=1)
